...
public class SkillDevApplication {
	...
	public static void main(String[] args) {
		...
		System.load("C:\\Users\\Nurzada\\AppData\\Local\\Programs\\Python\\Python311\\python311.dll");
		//System.load("/usr/lib/x86_64-linux-gnu/libpython3.8.so");
		try {
			MainInterpreter.setJepLibraryPath(new File("C:\\Users\\Nurzada\\AppData\\Local\\Programs\\Python\\Python311\\Lib\\site-packages\\jep\\jep.dll").getAbsolutePath());
